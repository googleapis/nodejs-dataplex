...
describe('v1.DataplexServiceClient', () => {
    ...
    describe('getLake', () => {
        it('invokes getLake without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetLakeRequest', ['name']);
    ...
    describe('getZone', () => {
        it('invokes getZone without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetZoneRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('getAsset', () => {
        it('invokes getAsset without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetAssetRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('cancelJob', () => {
        it('invokes cancelJob without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('CancelJobRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('createLake', () => {
        it('invokes createLake without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('CreateLakeRequest', ['parent']);
    ...
    describe('updateLake', () => {
        it('invokes updateLake without error', async () => {
            ...
            request.lake ??= {};
            const defaultValue1 =
              getTypeDefaultValue('UpdateLakeRequest', ['lake', 'name']);
    ...
    describe('deleteLake', () => {
        it('invokes deleteLake without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('DeleteLakeRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('createZone', () => {
        it('invokes createZone without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('CreateZoneRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('updateZone', () => {
        it('invokes updateZone without error', async () => {
            ...
            request.zone ??= {};
            const defaultValue1 =
              getTypeDefaultValue('UpdateZoneRequest', ['zone', 'name']);
    ...
    describe('deleteZone', () => {
        it('invokes deleteZone without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('DeleteZoneRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('createAsset', () => {
        it('invokes createAsset without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('CreateAssetRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('updateAsset', () => {
        it('invokes updateAsset without error', async () => {
            ...
            request.asset ??= {};
            const defaultValue1 =
              getTypeDefaultValue('UpdateAssetRequest', ['asset', 'name']);
    ...
    describe('deleteAsset', () => {
        it('invokes deleteAsset without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('DeleteAssetRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('updateTask', () => {
        it('invokes updateTask without error', async () => {
            ...
            request.task ??= {};
            const defaultValue1 =
              getTypeDefaultValue('UpdateTaskRequest', ['task', 'name']);
    ...
    describe('updateEnvironment', () => {
        it('invokes updateEnvironment without error', async () => {
            ...
            request.environment ??= {};
            const defaultValue1 =
              getTypeDefaultValue('UpdateEnvironmentRequest', ['environment', 'name']);
    ...
    describe('listLakes', () => {
        it('invokes listLakes without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListLakesRequest', ['parent']);
            request.parent = defaultValue1;
    ...
    describe('listLakeActions', () => {
        it('invokes listLakeActions without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListLakeActionsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
    ...
    describe('listZones', () => {
        it('invokes listZones without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListZonesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
    ...
    describe('listZoneActions', () => {
        it('invokes listZoneActions without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListZoneActionsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.dataplex.v1.Action()),
              generateSampleMessage(new protos.google.cloud.dataplex.v1.Action()),
    ...
    describe('listAssets', () => {
        it('invokes listAssets without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListAssetsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
    ...
    describe('listAssetActions', () => {
        it('invokes listAssetActions without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListAssetActionsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.dataplex.v1.Action()),
              generateSampleMessage(new protos.google.cloud.dataplex.v1.Action()),
    ...
    describe('listSessions', () => {
        it('invokes listSessions without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListSessionsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
