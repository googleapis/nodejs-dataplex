...
describe('v1.MetadataServiceClient', () => {
    ...
    describe('createEntity', () => {
        it('invokes createEntity without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('CreateEntityRequest', ['parent']);
    ...
    describe('updateEntity', () => {
        it('invokes updateEntity without error', async () => {
            ...
            request.entity ??= {};
            const defaultValue1 =
              getTypeDefaultValue('UpdateEntityRequest', ['entity', 'name']);
    ...
    describe('deleteEntity', () => {
        it('invokes deleteEntity without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('DeleteEntityRequest', ['name']);
    ...
    describe('getEntity', () => {
        it('invokes getEntity without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetEntityRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dataplex.v1.Entity()
    ...
    describe('createPartition', () => {
        it('invokes createPartition without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('CreatePartitionRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('deletePartition', () => {
        it('invokes deletePartition without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('DeletePartitionRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
    ...
    describe('getPartition', () => {
        it('invokes getPartition without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetPartitionRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dataplex.v1.Partition()
    ...
    describe('listEntities', () => {
        it('invokes listEntities without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListEntitiesRequest', ['parent']);
            request.parent = defaultValue1;
    ...
    describe('listPartitions', () => {
        it('invokes listPartitions without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListPartitionsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
