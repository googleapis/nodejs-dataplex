...
describe('v1.ContentServiceClient', () => {
    ...
    describe('createContent', () => {
        it('invokes createContent without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('CreateContentRequest', ['parent']);
    ...
    describe('updateContent', () => {
        it('invokes updateContent without error', async () => {
            ...
            request.content ??= {};
            const defaultValue1 =
              getTypeDefaultValue('UpdateContentRequest', ['content', 'name']);
    ...
    describe('deleteContent', () => {
        it('invokes deleteContent without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('DeleteContentRequest', ['name']);
    ...
    describe('getContent', () => {
        it('invokes getContent without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetContentRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.dataplex.v1.Content()
    ...
    describe('listContent', () => {
        it('invokes listContent without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListContentRequest', ['parent']);
            request.parent = defaultValue1;
